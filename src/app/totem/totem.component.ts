...
export default class TotemComponent {
  ...
  tabs: Tab[] = [
    { id: 1, titulo: 'Animal', activo: true, deshabilitado: false, cards: [
      { id: 1, titulo: 'hormiga', descripcion: 'Reconoces y utilizas eficazmente la fortaleza de los demás', imagen: 'assets/img/animales/ant.svg' },
      { id: 2, titulo: 'murciélago', descripcion: 'Ves las oportunidades emergentes mejor que nadie', imagen: 'assets/img/animales/bat.svg' },
      { id: 3, titulo: 'abeja', descripcion: 'Demuestras una eficiencia extraordinaria', imagen: 'assets/img/animales/bee.svg' },
      { id: 4, titulo: 'caribú', descripcion: 'No temes explorar nuevos caminos', imagen: 'assets/img/animales/ant.svg' },
      { id: 5, titulo: 'camaleón', descripcion: 'Te adaptas fácilmente a una variedad de situaciones', imagen: 'assets/img/animales/ant.svg' },
      { id: 6, titulo: 'caballo', descripcion: 'Permites que otros vayan más rápido y más lejos', imagen: 'assets/img/animales/ant.svg' },
      { id: 7, titulo: 'colibrí', descripcion: 'Haces todo con precisión y consideración', imagen: 'assets/img/animales/ant.svg' },
      { id: 8, titulo: 'leopardo', descripcion: 'Actúas rápidamente', imagen: 'assets/img/animales/ant.svg' },
      { id: 9, titulo: 'león', descripcion: 'Asumes naturalmente un rol de liderazgo', imagen: 'assets/img/animales/ant.svg' },
      { id: 10, titulo: 'ave lira', descripcion: 'Te llevas bien con todos', imagen: 'assets/img/animales/ant.svg' },
      { id: 11, titulo: 'monarca', descripcion: 'Nunca te rindes antes de llegar a tu destino', imagen: 'assets/img/animales/ant.svg' },
      { id: 12, titulo: 'ratón', descripcion: 'Prestas atención a los detalles', imagen: 'assets/img/animales/ant.svg' },
      { id: 13, titulo: 'búho', descripcion: 'Escuchas de manera sincera y genuina', imagen: 'assets/img/animales/ant.svg' },
      { id: 14, titulo: 'mapache', descripcion: 'Clasificas y organizas las cosas con destreza', imagen: 'assets/img/animales/ant.svg' },
      { id: 15, titulo: 'rinoceronte', descripcion: 'Te mantienes fiel y auténtico en todas las situaciones', imagen: 'assets/img/animales/ant.svg' },
      { id: 16, titulo: 'gallo', descripcion: 'Siempre se puede contar contigo', imagen: 'assets/img/animales/ant.svg' },
      { id: 17, titulo: 'ardilla', descripcion: 'Planificas hábilmente para responder a necesidades futuras', imagen: 'assets/img/animales/ant.svg' },
      { id: 18, titulo: 'cisne', descripcion: 'Te diferencias respetando a los demás', imagen: 'assets/img/animales/ant.svg' },
      { id: 19, titulo: 'tigre', descripcion: 'Lideras de manera justa y equitativa', imagen: 'assets/img/animales/ant.svg' },
      { id: 20, titulo: 'ballena', descripcion: 'Permaneces tranquilo en medio del caos', imagen: 'assets/img/animales/ant.svg' },
      { id: 21, titulo: 'salvaje', descripcion: 'Sabes cómo usar los problemas para mejorar tu vida', imagen: 'assets/img/animales/ant.svg' }
]
    },
